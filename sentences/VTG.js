...
module.exports = function(app) {
  return {
      ...
      keys: [
        'navigation.courseOverGroundMagnetic', 'navigation.courseOverGroundTrue', 'navigation.speedOverGround'
      ],
      f: function gll(courseOverGroundMagnetic, courseOverGroundTrue, speedOverGround) {
